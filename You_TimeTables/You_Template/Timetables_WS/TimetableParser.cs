...
namespace You_TimeTables.Timetables_WS
{
    public sealed class TimetableParser
    {
        ...
        public int _selectedCourseIndex = 0;
        ...
        private void SetCurrentSemester(List<Semestre> semestres)
        {
            foreach (Semestre s in semestres)
            {
                ...
                if (_month == 9 || _month == 10 || _month == 11 || _month == 12 || _month == 1)
                {
        ...
        //**********************************************meu código*****************************
        public void TimeTable_Semester_Chage()
        {
        ...
        public void TimeTable_AnoUm()
        {
            _selectedYear = 0;
            TimeTable_Refresh();
        }
        public void TimeTable_AnoDois()
        {
            _selectedYear = 1;
            TimeTable_Refresh();
        }
        public void TimeTable_AnoTres()
        {
            _selectedYear = 2;
            TimeTable_Refresh();
        }
        public void TimeTable_AnoQuatro()
        {
            _selectedYear = 3;
            TimeTable_Refresh();
        }
        public void TimeTable_AnoCinco()
        {
            _selectedYear = 4;
            TimeTable_Refresh();
        }
        ...
        /// <summary>
        /// Processes a TimeTable selection: MIEET
        /// </summary>
        public void TimeTable_MIEET()
        {
            _selectedCourseIndex = 0;
        ...
        /// <summary>
        /// Processes a TimeTable selection: MIECT
        /// </summary>
        public void TimeTable_MIECT()
        {
        ...
        /// <summary>
        /// Processes a TimeTable selection: TSI
        /// </summary>
        public void TimeTable_TSI()
        {
            _selectedCourseIndex = 2;
